...
#         grid layout
        ...
        self.create_widget(exercise_text).grid(row=0, column=2, sticky='nsew')

        self.pack(expand=True, fill='both', padx=10, pady=10)

    def create_widget(self, button_text):
...
# widgets
Segment(window, 'Label', 'Button', '123')
Segment(window, 'Test', 'Click', '456')
Segment(window, 'Hello', 'Test', '789')
Segment(window, 'Bye', 'Launch', '1011')
Segment(window, 'Last one', 'Exit', '1213')
